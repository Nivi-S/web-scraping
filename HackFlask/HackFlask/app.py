...
def scrapeHTML(str_url):
    ...
    #return 0 #str(press_source.confirmed)


def retconfirmed(press_source):
...
@app.route("/UCLA/")
def getUCLAnews():
    return scrapeHTML('https://newsroom.ucla.edu/stories/coronavirus-information-for-the-ucla-campus-community')


@app.route("/USC/")
def getUSCnews():
    # press_source = scrapeHTML('https://sites.usc.edu/coronavirus/')
    # return str(press_source.confirmed)
    return scrapeHTML('https://sites.usc.edu/coronavirus/')


@app.route("/LAC/")
def getLACnews():
    return scrapeHTML('http://publichealth.lacounty.gov/media/Coronavirus/')


@app.route("/CA/")
def getCAnews():
     return scrapeHTML('https://www.cdph.ca.gov/Programs/CID/DCDC/Pages/Immunization/ncov2019.aspx')



@app.route("/CDC/")
def getCDCnews():
    return scrapeHTML('https://www.cdc.gov/coronavirus/2019-ncov/cases-in-us.html')
